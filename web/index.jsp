...
<div class="admin">
   ...
   <div class="admin-index">
    ...
    <div class="shuju">
      <div class="xinxitj">数据统计</div>
      <br/>
      <div class="shujuone">
        <dl>
          <dt>售出商品数量：  1356666</dt>
          <dt>售出商品总金额：   5646465.98</dt>
          <dt>售出商品利润：  546464</dt>
        </dl>
        <ul>
          <h2>26.83%</h2>
    ...
    <div class="foods">
    	<ul> <a href="http://www.cssmoban.com/" target="_blank" title="模板之家"></a> -  More Templates<a href="http://www.cssmoban.com/" title="" target="_blank">网页模板</a></ul>
